...
% Zitate und Literaturverzeichnis mit biblatex (APA 7th / Harvard gemäß DHBW CAS)
...
\begin{document}
  ...
  \include{chapter/10_AllChapter}

  % 7. Anhang (optional, bei Bedarf einkommentieren)
  %\begin{appendix}
