...
\toprule
\textbf{Key \& Zitat} & \textbf{Autoren \& Jahr} & \textbf{Zugewiesene Epoche} & \textbf{Zuordnungsgrundlage} & \textbf{Wandelstreiber} \\
\midrule
\endfirsthead
...
\cite{LZQJ6M4X} & Paschetta \& Tsoukiàs (2000) & Epoche 1 (2000--2007) & Frühe ELECTRE-TRI Outranking-Kategorisierung & Ablösung subjektiver Checklisten durch Outranking \\
\cite{M3B2D3GD} & Blin \& Tsoukiàs (2001) & Epoche 1 (2000--2007) & ELECTRE II gekoppelt mit ISO 9126 Qualitätsmodell & Vermeidung arithmetischer Summen-Fallen \\
\cite{QDUNCXFC} & Morris \& Beling (2001) & Epoche 1 (2000--2007) & Bayes'sche Netze für Kriterienwahrscheinlichkeiten & Probabilistische Risikomodellierung \\
\cite{FCYW9EWJ} & Sarkis \& Sundarraj (2003) & Epoche 1 (2000--2007) & Mehrstufiges Screening mit AHP-Hierarchie & Hierarchische Kriterienstrukturierung \\
\cite{DAU8NSK8} & Colombo \& Francalanci (2004) & Epoche 1 (2000--2007) & AHP-Anwendung auf CRM-Softwareauswahl & Strukturierte Unternehmenssoftware-Beschaffung \\
\cite{TLB687YL} & Franch (2005) & Epoche 1 (2000--2007) & Leichtgewichtiges goal-orientiertes Matching & Brücke zwischen Requirements und COTS \\
\cite{CI86GRRG} & Cooper et al. (2005) & Epoche 1 (2000--2007) & Fuzzy Sets für komponentenbasierte Spezifikationen & Behandlung vager Herstellerspezifikationen \\
\cite{CZZ6XQZJ} & Wanyama \& Far (2005) & Epoche 1 (2000--2007) & NeMo-CoSe: Anforderungsverhandlung \& Spieltheorie & Konfliktlösung bei Stakeholder-Anforderungen \\
\cite{U5JPV4SF} & Shyur (2006) & Epoche 1 (2000--2007) & 5-Phasen-Modell aus ANP und modifiziertem TOPSIS & Abbildung von Kriterien-Wechselwirkungen \\
\cite{8XNYS4M9} & Cechich \& Piattini (2006) & Epoche 1 (2000--2007) & AGORA-Zielgrapherweiterung für Konfliktanalysen & Quantifizierung von Zielkonflikten \\
\cite{6RNULWVY} & Chung et al. (2006) & Epoche 1 (2000--2007) & CARE Framework: NFR-Zielgraphen \& MDE & Architektureinhaltung durch NFR-Rückverfolgung \\
\cite{MC9UMXZZ} & Mohamed et al. (2007) & Epoche 1 (2000--2007) & MiHOS: Mismatch-Klassifikation \& ILP-Solver & Bewusstsein für post-evaluative Anpassungskosten \\
\cite{9F79VAAB} & Mohamed (2007) & Epoche 1 (2000--2007) & MiHOS Dissertation: 6 Mismatch-Typen \& MiHOS-PT & Formale Mismatch-Behebung unter Budgetgrenzen \\
\cite{ZQMG69VT} & Neubauer \& Stummer (2007) & Epoche 1 (2000--2007) & Odin Tool: MOCO \& interaktive Pareto-Erkundung & Vermeidung starrer A-priori-Kriteriengewichte \\
\cite{MZ8JHDYA} & Neubauer et al. (2008) & Epoche 2 (2008--2016) & Atana: MOCO mit NSGA-II Metaheuristik & Skalierung auf mehrkomponentige Systeme \\
\cite{WBGP3ETU} & Skroch (2010) & Epoche 2 (2008--2016) & Multipfad-Prozessmodell \& Perzentil-Matching & Standardisierung von COTS-Integrationsabläufen \\
\cite{8VHUMEKY} & Becker \& Rauber (2010) & Epoche 2 (2008--2016) & Plato DSS-Plattform für evidenzbasierte Auswahl & Automatisierte langfristige Software-Preservation \\
\cite{VUVLUN85} & Jha et al. (2010) & Epoche 2 (2008--2016) & 0-1 bi-kriterielle ganzzahlige Programmierungsmodelle & Exakte mathematische Budget-Optimierung \\
\cite{U4E7VXQU} & Jadhav \& Sonar (2011) & Epoche 2 (2008--2016) & HKBS: Experten-Regelsystem mit IF-THEN Logik & Automatisierte Wissensverarbeitung in DSS \\
\cite{6YJHIVHG} & Gupta et al. (2012) & Epoche 2 (2008--2016) & Fuzzy interaktives 0-1 MINLP Modell & Modellierung unscharfer Systemparameter \\
\cite{VRTXHQI7} & Roshanaei et al. (2013) & Epoche 2 (2008--2016) & Adaptives AHP gekoppelt mit Genetischen Algorithmen & Beherrschung dynamischer Kriterienänderungen \\
\cite{W8P543Y2} & Park \& Jeong (2013) & Epoche 2 (2008--2016) & QoS-basiertes MCDM-Modell für SaaS-ERP & Anpassung an Cloud-SLAs und Service-Qualität \\
\cite{WZM7DUBY} & Al-Tarawneh (2014) & Epoche 2 (2008--2016) & COTS-ESF Framework \& DM-PT Software-Tool & Operatives Gesamtmodell mit ISO 9126 Bezug \\
\cite{LYMHTPXS} & Delgado et al. (2015) & Epoche 2 (2008--2016) & Strukturierte Evaluierungsmethode für BPM-Engines & Domänenspezifische Middleware-Evaluierung \\
