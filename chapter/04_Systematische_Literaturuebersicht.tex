...
\begin{table}[p]
  ...
  \begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash}p{2.6cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{3.8cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{4.5cm}}
    \toprule
    ...
    \textbf{Epoche 1} \newline (2000--2005) 
      ...
      & Übergang von Ad-hoc-Entscheidungen zu formaler MCDA und ISO 9126-Normenbezug.
