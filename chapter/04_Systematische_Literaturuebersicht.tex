...
Im Rahmen des durchgeführten Cross-Consistency Assessments (CCA) wurden alle $\binom{6}{2} = 15$ zweidimensionalen Sub-Matrizen mit insgesamt 219 paarweisen Zustandskombinationen evaluiert: 154 Kombinationen wurden in der Literatursammlung empirisch beobachtet ($O$), 61 Kombinationen stellen plausible und theoretisch konsistente Innovationsräume dar ($?$), während 4 Kombinationen als logisch-strukturell inkonsistent identifiziert wurden ($X$).
