...
\begin{table}[htbp]
  \centering
  \small
  \caption{Phasen und Schritte des methodischen Vorgehens nach \textcite[S.~882--905]{2NHFUF5N}}
  \label{tab:okoli_phasen}
  \begin{tabularx}{\textwidth}{l>{\raggedright\arraybackslash}p{3.2cm}X>{\raggedright\arraybackslash}p{3.5cm}}
    \toprule
    ...
    \multirow{2}{*}{\textbf{1. Planung}} 
      & 1. Identify Purpose & Präzisierung der Forschungsziele und Forschungsfragen (RQ1--RQ3) & Problemstellung, Zieltaxonomie \\
      & 2. Draft Protocol & Spezifikation des Review-Protokolls und des Mastersuchstrings & Gemini 3.1 Pro, PRISMA 2020 \\
    \addlinespace[2pt]
    \multirow{2}{*}{\textbf{2. Auswahl}} 
      & 3. Search Literature & Systematische Recherche in vier wissenschaftlichen Fachdatenbanken & IEEE, ACM, EBSCO, Springer, Python-API \\
      & 4. Apply Practical Screen & Dreistufiger Filterprozess (Metadaten-, Relevanz- und Eignungsprüfung) & Zotero, Gemini 3.5 Flash, Screening-Raster \\
    \addlinespace[2pt]
    \multirow{2}{*}{\textbf{3. Extraktion}} 
      & 5. Appraise Quality & Methodische Qualitätsbewertung anhand von QA1--QA4 & Gemini 3.7 Flash, \texttt{verify\_quotes.py} \\
      & 6. Extract Data & Strukturierte 18-spaltige Evidenz- und Merkmaltextraktion & Subagent-per-Paper, JSON-Textextraktion \\
    \addlinespace[2pt]
    \multirow{2}{*}{\textbf{4. Ausführung}} 
      & 7. Synthesize Studies & Evolutionäre Analyse \& General Morphological Analysis (GMA) & Ritchey-Formalismus, Kreuzkonsistenz \\
      & 8. Write Review & Wissenschaftliche Berichterstattung gemäß akademischer Standards & LaTeX, Shiny App \parencite{MQ9M8Q7L} \\
    \bottomrule
  \end{tabularx}
\end{table}

Für die vorliegende Arbeit wird das von \textcite[S.~882--905]{2NHFUF5N} etablierte Leitfadenmodell zugrunde gelegt. Dieses gliedert sich in vier sequentielle Phasen mit acht aufeinander aufbauenden Einzelschritten (siehe Tabelle~\ref{tab:okoli_phasen}):
...
\begin{table}[htbp]
  ...
  \label{tab:qa_schema}
  \begin{tabularx}{\textwidth}{l>{\raggedright\arraybackslash}p{4.2cm}X>{\raggedright\arraybackslash}p{3.8cm}}
    \toprule
    ...
    \midrule
    \multicolumn{4}{p{\dimexpr\textwidth-2\tabcolsep\relax}}{\textbf{Definition der Evidenzstufen auf Basis des Gesamtscores (0 bis 8 Punkte):} \newline
